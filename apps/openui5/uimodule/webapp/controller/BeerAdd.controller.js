sap.ui.define(["com/apress/openui5/controller/BaseController", "sap/ui/model/json/JSONModel", "sap/ui/core/ValueState"],
    function (Controller, JSONModel, ValueState) {
        ...
        return Controller.extend("com.apress.openui5.controller.BeerAdd", {
            ...
            triggerValidation: function (updateValueState) {
                const inputs = this.getView().getControlsByFieldGroupId("newBeer").filter(function (c) {

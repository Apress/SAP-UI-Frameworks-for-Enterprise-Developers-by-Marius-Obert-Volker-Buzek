...
sap.ui.define(["sap/esh/search/ui/eventlogging/UsageAnalyticsConsumer"], function (UsageAnalyticsConsumer) {
  ...
  var UsageAnalyticsConsumerSina = /*#__PURE__*/function (_UsageAnalyticsConsum) {
    _inherits(UsageAnalyticsConsumerSina, _UsageAnalyticsConsum);
    var _super = _createSuper(UsageAnalyticsConsumerSina);
    function UsageAnalyticsConsumerSina() {
    ...
    _createClass(UsageAnalyticsConsumerSina, [{
      ...
      value:
      // =======================================================================
      //   Usage Analytics Event Consumer --- Sina
      // =======================================================================

      // dummy

      function init(sinaNext) {

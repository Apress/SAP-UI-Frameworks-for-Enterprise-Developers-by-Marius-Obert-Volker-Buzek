...
sap.ui.define(["./SearchTermSuggestion", "./SuggestionType"], function (___SearchTermSuggestion, ___SuggestionType) {
  ...
  var SearchTermAndDataSourceSuggestion = /*#__PURE__*/function (_SearchTermSuggestion) {
    _inherits(SearchTermAndDataSourceSuggestion, _SearchTermSuggestion);
    var _super = _createSuper(SearchTermAndDataSourceSuggestion);
    // _meta: {
    //     properties: {
    //         dataSource: {
    //             required: true
    ...
    function SearchTermAndDataSourceSuggestion(properties) {
      var _properties$dataSourc;
      var _this;
      _classCallCheck(this, SearchTermAndDataSourceSuggestion);
      _this = _super.call(this, properties);
      _defineProperty(_assertThisInitialized(_this), "type", SuggestionType.SearchTermAndDataSource);
    ...
    return _createClass(SearchTermAndDataSourceSuggestion);

...
sap.ui.define(["./FacetResultSetItem"], function (___FacetResultSetItem) {
  ...
  var DataSourceResultSetItem = /*#__PURE__*/function (_FacetResultSetItem) {
    _inherits(DataSourceResultSetItem, _FacetResultSetItem);
    var _super = _createSuper(DataSourceResultSetItem);
    // _meta: {
    //     properties: {
    //         dataSource: {
    //             required: true
    ...
    function DataSourceResultSetItem(properties) {
      ...
      var _this;
      _classCallCheck(this, DataSourceResultSetItem);
    ...
    return _createClass(DataSourceResultSetItem);
  }(FacetResultSetItem);
  var __exports = {
    __esModule: true
  };

...
sap.ui.define(["./FacetQuery"], function (___FacetQuery) {
  ...
  var DataSourceQuery = /*#__PURE__*/function (_FacetQuery) {
    _inherits(DataSourceQuery, _FacetQuery);
    var _super = _createSuper(DataSourceQuery);
    function DataSourceQuery(properties) {
      var _properties$dataSourc;
      var _this;
      _classCallCheck(this, DataSourceQuery);
    ...
    return _createClass(DataSourceQuery);
  }(FacetQuery);
  var __exports = {
    __esModule: true
  };

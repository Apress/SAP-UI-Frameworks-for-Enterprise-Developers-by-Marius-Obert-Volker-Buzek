...
sap.ui.define(["../../core/util", "./Formatter"], function (util, ___Formatter) {
  ...
  var RemovePureAdvancedSearchFacetsFormatter = /*#__PURE__*/function (_Formatter) {
    _inherits(RemovePureAdvancedSearchFacetsFormatter, _Formatter);
    var _super = _createSuper(RemovePureAdvancedSearchFacetsFormatter);
    function RemovePureAdvancedSearchFacetsFormatter() {
      _classCallCheck(this, RemovePureAdvancedSearchFacetsFormatter);
      return _super.apply(this, arguments);
    }
    _createClass(RemovePureAdvancedSearchFacetsFormatter, [{
      key: "initAsync",
      value:

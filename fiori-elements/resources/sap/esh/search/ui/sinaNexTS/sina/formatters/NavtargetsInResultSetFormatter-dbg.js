...
sap.ui.define(["../../core/util", "./Formatter"], function (util, ___Formatter) {
  ...
  var NavtargetsInResultSetFormatter = /*#__PURE__*/function (_Formatter) {
    _inherits(NavtargetsInResultSetFormatter, _Formatter);
    var _super = _createSuper(NavtargetsInResultSetFormatter);
    function NavtargetsInResultSetFormatter() {
      _classCallCheck(this, NavtargetsInResultSetFormatter);
      return _super.apply(this, arguments);
    }
    _createClass(NavtargetsInResultSetFormatter, [{
      key: "initAsync",
      value:
    ...
    return NavtargetsInResultSetFormatter;
  }(Formatter);
  var __exports = {
    __esModule: true
  };

...
sap.ui.define([ 'sap/ui/commons/library', 'sap/ui/commons/RangeSliderRenderer', 'sap/ui/core/Renderer' ],
	function(CommonsLibrary, RangeSliderRenderer, Renderer) {
	"use strict";
	 ...
	 * @static
	 */
	var DateRangeSliderInternalRenderer = Renderer.extend(RangeSliderRenderer);

	/**
	 * Render buffer div to accommodate bubbles height.
	 *
	 * @param {sap.ui.core.RenderManager} oRm the RenderManager that can be used for writing to the render output buffer
	 * @param {sap.suite.ui.commons.DateRangeSliderInternal} oDateRangeSliderInternal an object representation of the control that should be rendered
	 * @protected
	 */
	DateRangeSliderInternalRenderer.renderBufferDivForBubbles = function(oRm, oDateRangeSliderInternal) {
		if (oDateRangeSliderInternal.getShowBubbles()) {
			oRm.write('<DIV id="' + oDateRangeSliderInternal.getId() + '-bubbleBuffer"');
	 ...
	 * @protected
	 */
	DateRangeSliderInternalRenderer.renderEnclosingDiv = function(oRm, oDateRangeSliderInternal) {
		oRm.write('<DIV');
		...
		} else if (!oDateRangeSliderInternal.getEditable()) {
	 ...
	 * @protected
	 */
	DateRangeSliderInternalRenderer.renderEnclosingDivEnd = function(oRm, oDateRangeSliderInternal) {
		oRm.write('</DIV>');
	};
	 ...
	 * @protected
	 */
	DateRangeSliderInternalRenderer.renderAriaGripTooltip = function(oRm, oDateRangeSliderInternal) {
		if (oDateRangeSliderInternal.getTooltip_AsString()) {
			oRm.write('<SPAN id="' + oDateRangeSliderInternal.getId() + '-Descr"');
	 ...
	 * @protected
	 */
	DateRangeSliderInternalRenderer.renderBubbles = function(oRm, oDateRangeSliderInternal) {
		if (!oDateRangeSliderInternal.getShowBubbles()) {
			return;
		}
	 ...
	 * @protected
	 */
	DateRangeSliderInternalRenderer.renderSliderBar = function(oRm, oDateRangeSliderInternal) {
		oRm.write('<DIV');
	 ...
	 * @protected
	 */
	DateRangeSliderInternalRenderer.renderSliderBarEnd = function(oRm, oDateRangeSliderInternal) {
	 ...
	 * @protected
	 */
	DateRangeSliderInternalRenderer.renderTicksAndLabels = function(oRm, oDateRangeSliderInternal) {
	 ...
	 * @protected
	 */
	DateRangeSliderInternalRenderer.renderHighlightBar = function(oRm, oDateRangeSliderInternal) {
		// Highlight bar
		oRm.write('<DIV');
	 ...
	 * @param {sap.suite.ui.commons.DateRangeSliderInternal} oDateRangeSliderInternal An object representation of the control that should be rendered.
	 */
	DateRangeSliderInternalRenderer.renderGrip = function(oRm, oDateRangeSliderInternal) {
		// Left Grip
		oRm.write('<DIV');
	 ...
	 * @param {sap.suite.ui.commons.DateRangeSliderInternal} oDateRangeSliderInternal An object representation of the control that should be rendered.
	 */
	DateRangeSliderInternalRenderer.renderGrip2 = function(oRm, oDateRangeSliderInternal) {
		// Right Grip
		oRm.write('<DIV');
		// Icon for grip
	 ...
	 * @param {sap.suite.ui.commons.DateRangeSliderInternal} oDateRangeSliderInternal an object representation of the control that should be rendered
	 */
	DateRangeSliderInternalRenderer.render = function(oRm, oDateRangeSliderInternal) {
	...
	return DateRangeSliderInternalRenderer;
}, /* bExport= */ true);
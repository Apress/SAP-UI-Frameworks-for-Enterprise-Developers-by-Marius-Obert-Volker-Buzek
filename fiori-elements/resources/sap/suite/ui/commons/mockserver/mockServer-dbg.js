sap.ui.define([
	...
	return ManagedObject.extend("sap.ovp.Mockserver.mockServer", {
		started: null,
		init: function () {
			this.started = jQuery.get("test-resources/sap/suite/ui/commons/demokit/sample/CloudFilePicker/mockserver/FileShareItems.json").then(function (data, status, jqXHR) {
				this.mockData = data;
				return jQuery.get("test-resources/sap/suite/ui/commons/demokit/sample/CloudFilePicker/mockserver/metadata.xml");

...
sap.ui.define([
	...
	var waitForEditableVariantItemByVariantName = function (sVariantName, oSettings) {
		return this.waitFor({
			...
			actions: function (oEditableVariantItem) {
				var oCell = oEditableVariantItem.getCells()[1];
	...
	return {
		 ...
		 * @returns {object} The result of the {@link sap.ui.test.Opa5#waitFor} function, to be used for chained statements
		 */
		iOpenMyView: function (sSVMId) {
			return this.iPressButtonWithID(sSVMId + "-vm-trigger");
		},
		 ...
		 * @returns {object} The result of the {@link sap.ui.test.Opa5#waitFor} function, to be used for chained statements
		 */
		iOpenSaveView: function (sSVMId) {
			return this.iPressButtonWithID(sSVMId + "-vm-saveas");
		},
		 ...
		 * @returns {object} The result of the {@link sap.ui.test.Opa5#waitFor} function, to be used for chained statements
		 */
		iOpenManageViews: function (sSVMId) {
			return this.iPressButtonWithID(sSVMId + "-vm-manage");
		},
		 ...
		 * @returns {object} The result of the {@link sap.ui.test.Opa5#waitFor} function, to be used for chained statements
		 */
		iPressTheManageViewsSave: function (sSVMId) {
			return this.iPressButtonWithID(sSVMId + "-vm-managementsave");
		},
		 ...
		 * @returns {object} The result of the {@link sap.ui.test.Opa5#waitFor} function, to be used for chained statements
		 */
		iCreateNewVariant: function (sSVMId, sVariantTitle, bDefault, bApplyAuto) {
			return this.waitFor({
				id: sSVMId + "-vm-name",
				success: function (oInput) {
					...
					if (bApplyAuto) {
						this.waitFor({
							id: sSVMId + "-vm-execute",
							actions: new Press()
						});
					}

					return this.waitFor({
						id: sSVMId + "-vm-variantsave",
						actions: new Press()
					});
				},

...
(function(){
sap.ui.define(["./Formatter", "../../configurationEngine/configuratorFactory"], function (___Formatter, configuratorFactory) {
   ...
   * instead of code.
   */
  var ConfigFormatter = /*#__PURE__*/function (_Formatter) {
    _inherits(ConfigFormatter, _Formatter);
    var _super = _createSuper(ConfigFormatter);
    function ConfigFormatter(type, configuration) {
      var _this;
      _classCallCheck(this, ConfigFormatter);
      _this = _super.call(this);
      _this.type = type;
      _this.configuration = configuration;
      return _this;
    }
    _createClass(ConfigFormatter, [{
      key: "initAsync",
      ...
      key: "formatAsync",
      value: function formatAsync(obj) {
  ...
  __exports.ConfigFormatter = ConfigFormatter;
  return __exports;
});
})();
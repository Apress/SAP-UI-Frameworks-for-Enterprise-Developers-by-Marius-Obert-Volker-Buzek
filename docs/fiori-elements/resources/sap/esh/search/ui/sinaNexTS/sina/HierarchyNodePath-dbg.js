...
sap.ui.define(["./SinaObject"], function (___SinaObject) {
  ...
  var HierarchyNodePath = /*#__PURE__*/function (_SinaObject) {
    _inherits(HierarchyNodePath, _SinaObject);
    var _super = _createSuper(HierarchyNodePath);
    function HierarchyNodePath(properties) {
      var _this;
      _classCallCheck(this, HierarchyNodePath);
      _this = _super.call(this, properties);
      _this.name = properties.name;
      _this.path = properties.path;
      return _this;
    }
    return _createClass(HierarchyNodePath);
  }(SinaObject);
  var __exports = {
    __esModule: true
  };

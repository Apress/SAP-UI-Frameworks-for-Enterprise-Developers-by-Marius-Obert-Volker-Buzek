...
sap.ui.define([], function () {
  ...
  var ChartResultSetFormatter = /*#__PURE__*/function (_Formatter) {
    _inherits(ChartResultSetFormatter, _Formatter);
    var _super = _createSuper(ChartResultSetFormatter);
    function ChartResultSetFormatter() {
      _classCallCheck(this, ChartResultSetFormatter);
      return _super.apply(this, arguments);
    }
    return _createClass(ChartResultSetFormatter);
  }(Formatter);
  var __exports = {
    __esModule: true
  };

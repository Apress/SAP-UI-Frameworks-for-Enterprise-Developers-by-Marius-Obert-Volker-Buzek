...
sap.ui.define(["../../core/core", "./Configurator"], function (core, ___Configurator) {
  ...
  var TextResourceConfigurator = /*#__PURE__*/function (_Configurator) {
    _inherits(TextResourceConfigurator, _Configurator);
    var _super = _createSuper(TextResourceConfigurator);
    function TextResourceConfigurator() {
      _classCallCheck(this, TextResourceConfigurator);
      return _super.apply(this, arguments);
    }
    _createClass(TextResourceConfigurator, [{
      key: "initAsync",
      ...
      value: function isSuitable(options) {
        if (core.isString(options.type) && ["string"].indexOf(options.type) >= 0 && core.isObject(options.configuration) && options.configuration.resourceKey) {
          return true;
        }
        return false;
      }
  ...
  __exports.TextResourceConfigurator = TextResourceConfigurator;
  return __exports;
});
})();
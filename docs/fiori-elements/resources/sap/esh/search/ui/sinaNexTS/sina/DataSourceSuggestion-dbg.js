...
sap.ui.define(["./Suggestion", "./SuggestionType"], function (___Suggestion, ___SuggestionType) {
  ...
  var DataSourceSuggestion = /*#__PURE__*/function (_Suggestion) {
    _inherits(DataSourceSuggestion, _Suggestion);
    var _super = _createSuper(DataSourceSuggestion);
    // _meta: {
    //     properties: {
    //         dataSource: {
    //             required: true
    ...
    function DataSourceSuggestion(properties) {
      ...
      var _this;
      _classCallCheck(this, DataSourceSuggestion);
      _this = _super.call(this, properties);
      _defineProperty(_assertThisInitialized(_this), "type", SuggestionType.DataSource);
    ...
    return _createClass(DataSourceSuggestion);
  }(Suggestion);
  var __exports = {
    __esModule: true
  };

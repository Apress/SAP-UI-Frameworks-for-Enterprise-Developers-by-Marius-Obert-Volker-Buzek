...
sap.ui.define(["sap/esh/search/ui/eventlogging/UsageAnalyticsConsumer"], function (UsageAnalyticsConsumer) {
  ...
  var UsageAnalyticsConsumerFlp = /*#__PURE__*/function (_UsageAnalyticsConsum) {
    _inherits(UsageAnalyticsConsumerFlp, _UsageAnalyticsConsum);
    ...
    _createClass(UsageAnalyticsConsumerFlp, [{
      ...
      value:
      // =======================================================================
      //  Usage Analytics Event Consumer --- Fiori Launchpad
      // =======================================================================
